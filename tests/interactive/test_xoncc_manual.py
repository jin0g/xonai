...
'''
            ...
            if result.returncode == 0 and expected in result.stdout:
                ...
                print(f"❌ {cmd} - Expected: '{expected}', Got stdout: '{result.stdout}', stderr: '{result.stderr}'")
...
'''
    ...
    try:
        ...
        if (result.returncode == 0 and 
            "Variables: x=42, y=test" in result.stdout and
            "Hello, xoncc!" in result.stdout and
            "PASS: Python integration works" in result.stdout):
